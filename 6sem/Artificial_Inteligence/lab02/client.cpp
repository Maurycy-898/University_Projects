...
Maurycy Sosnowski
Added engine to play as client
Engine ver. 0.1
2023-05-07
****************************/
...
int main(int argc, char *argv[]) {
  ...
  // Check if correct amount of args provided
  if (argc!=5) {
  ...
  if (depth < 1 || depth > 10) {
    printf("Wrong depth (should be > 0 and < 10)");
    return -1;
  }
  ...
  // Represents this game for engine
