...
public abstract class CommonPart {
     ...
     */
    protected void update(CheckedFrequencyTable frequencies, int symbol) throws IOException {
        // State check
        ...
        long symLow = frequencies.getLow(symbol);
        long symHigh = frequencies.getHigh(symbol);
        if (symLow == symHigh)
