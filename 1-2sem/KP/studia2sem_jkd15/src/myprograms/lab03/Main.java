...
public class Main {
    public static void main(String[] args) {
        ...
        for(int k=0; k<ileDanych; k++){
            if(wymiary[k] <= 0){
                System.out.println("Podales zle parametry, wymiary figur i katy musza byc wieksze od zera !!!");
                return;
            }
        }
        ...
        for (int i = 0; i < ileFigur; i++){
            if (literyFigur[i].equals("o")){
                if(ileDanych - wymiaryWsk < 1) {
                    System.out.println("Podales za malo danych!");
                    return;
                }
                ...
                if(czyForemny && (wymiary[wymiaryWsk+4]==90)){
                    ...
                    System.out.println("Podales nieobslugiwane wymiary(4-kąt) !!!");
                    break;
               }
            }
                ...
                if(czyForemny) {
                    ...
                    System.out.println("Podales nieobslugiwane wymiary(5-kąt) !!!");
                    break;
                }
            }
                ...
                if(czyForemny) {
                    ...
                    System.out.println("Podales nieobslugiwane wymiary (6-kąt) !!!");
                    break;
                }
            }
            else{
                System.out.println("Program nie obsluguje takiej figury !!!  "+ literyFigur[i]);
                break;
            }
        }
